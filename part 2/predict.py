...
parser.add_argument("-path", "-p", action="store", default= "checkpoint.pth")
parser.add_argument("-data_dir", action="store", default= "flowers")
parser.add_argument("-img", action="store", default="paind-project/flowers/test/1/image_06752.jpg")
...
probabilities = model_file.predict(img, model, topk)
